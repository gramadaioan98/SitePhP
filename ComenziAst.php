...
<BR><BR>
    ...
    ?>
        ...
        <h2><b> Telefon:</b> <?php echo $comanda['telefon'] ?> </h2>
                ...
                <a class="a1" href="Sterge-comanda.php?id=<?php echo $comanda['com_id'];?>&status=<?php echo $comanda['status'];?>"> Sterge </a>
                <a href="Trimite-comanda.php?id=<?php echo $comanda['com_id'];?>&status=<?php echo $comanda['status'];?>&ast=1"> Trimite </a>
                </div>
    <?php } ?>
